...
namespace fv
{
    ...
    std::string
    ZMM::getI32Representation() const
    {
        std::stringstream ss;
    ...
    std::string
    ZMM::getF32Representation() const
    {
        std::stringstream ss;
    ...
    std::string
    ZMM::getF64Representation() const
    {
        std::stringstream ss;
