...
namespace fv
{
    ...
    /// <param name="b">Input.</param>
    /// <param name="c">Output.</param>
    void vcase_arith_f32_1(__m512& a,
                           __m512& b,
                           __m512& c)
    {
        __m512 add = _mm512_add_ps(a, b);
        __m512 sub = _mm512_sub_ps(a, b);
        __m512 mul = _mm512_mul_ps(a, b);
        __m512 div = _mm512_div_ps(a, b);
        __m512 min = _mm512_min_ps(a, b);
        __m512 max = _mm512_max_ps(a, b);

        __m512 v0 = _mm512_add_ps(add, sub);
        __m512 v1 = _mm512_add_ps(v0, mul);
        __m512 v2 = _mm512_add_ps(v1, div);
        __m512 v3 = _mm512_add_ps(v2, min);
    ...
    /// <param name="b">Input.</param>
    /// <param name="c">Output.</param>
    void vcase_blend_f32_1(__m512& a,
                           __m512& b,
                           __m512& c)
    {
    ...
    /// <param name="c">Input.</param>
    /// <param name="h">Output.</param>
    void vcase_square_equation_1(__m512& a,
                                 __m512& b,
                                 __m512& c,
                                 __m512& h)
    {
    ...
    namespace riemann
    {
        ...
        /// Vector constant G.
        /// </summary>
        __m512 g = _mm512_set1_ps(sg);

        /// <summary>
        /// Vector constant G1.
        /// </summary>
        __m512 g1 = _mm512_set1_ps(sg1);

        /// <summary>
        /// Vector constant G2.
        /// </summary>
        __m512 g2 = _mm512_set1_ps(sg2);

        /// <summary>
        /// Vector constant G3.
        /// </summary>
        __m512 g3 = _mm512_set1_ps(sg3);

        /// <summary>
        /// Vector constant G4.
        /// </summary>
        __m512 g4 = _mm512_set1_ps(sg4);

        /// <summary>
        /// Vector constant G5.
        /// </summary>
        __m512 g5 = _mm512_set1_ps(sg5);

        /// <summary>
        /// Vector constant G6.
        /// </summary>
        __m512 g6 = _mm512_set1_ps(sg6);

        /// <summary>
        /// Vector constant G7.
        /// </summary>
        __m512 g7 = _mm512_set1_ps(sg7);

        /// <summary>
        /// Vector constant G8.
        /// </summary>
        __m512 g8 = _mm512_set1_ps(sg8);
    }
                        ...
                        __mmask16 m)
    {
        ...
        __m512 f1 = _mm512_mask_blend_ps(cond, f, f0);
        __m512 fd1 = _mm512_mask_blend_ps(cond, fd, fd0);
        __m512 f2;
        __m512 fd2;
	    ...
	    if (ncond != 0x0)
        {
            ...
            f2 = _mm512_mask_mul_ps(f1, ncond, ppk, qrt);
            fd2 =
                _mm512_mask_mul_ps(
                    fd1, ncond, qrt,
                    _mm512_fnmadd_ps(
        ...
        f = _mm512_mask_blend_ps(ncond, f1, f2);
        fd = _mm512_mask_blend_ps(ncond, fd1, fd2);
    }
                        ...
                        __m512& p)
    {
        ...
        __m512 p0 = _mm512_mask_blend_ps(cond_um, pl, pr);
        ...
        __m512 pms = _mm512_div_ps(pm, p0);
        ...
        __m512 d1 =
            _mm512_mask_mov_ps(
                ...
                _mm512_mul_ps(
                    d0,
                    _mm512_pow_ps(pms, _mm512_set1_ps(1.0f / riemann::sg))));
        __m512 d2 =
            _mm512_mask_mov_ps(
                d1, cond_s,
                _mm512_mul_ps(
        ...
        __m512 p1 = _mm512_mask_mov_ps(p0, _mm512_kor(cond_st, cond_s), pm);
	    ...
	    if (cond_sh_st != 0x0)
        {
            ...
            d3 =
                _mm512_mask_mov_ps(
                    d2, cond_sh_st,
                    _mm512_mul_ps(d2, _mm512_pow_ps(uc, riemann::g4)));
            p2 =
                _mm512_mask_mov_ps(
                    p1, cond_sh_st,
                    _mm512_mul_ps(p1, _mm512_pow_ps(uc, riemann::g3)));
        }
        ...
        p = _mm512_mask_blend_ps(cond_sh_st, p1, p2);
    }
    ...
    /// <param name="w">Output.</param>
    /// <param name="p">Output.</param>
    void vcase_riemann_1(__m512& dl,
                         __m512& ul,
                         __m512& vl,
                         __m512& wl,
                         __m512& pl,
